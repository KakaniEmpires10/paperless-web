...
<template>
  <footer class="relative mt-auto bg-accent">
    <div
      ...
      <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
        <a
          ...
          <span class="ml-3 text-xl font-semibold">Paperless Hospital</span>
        </a>
        <p class="mt-2 text-sm text-surface-700 dark:text-surface-300">
          Solusi terintegrasi AI untuk masa depan layanan kesehatan yang lebih
          baik dan efisien
        </p>
      </div>
      <div
        ...
        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
          <h2
            class="title-font font-medium text-accent-foreground tracking-widest text-sm mb-3">
            Quick Links
          </h2>
        ...
        <div class="md:w-1/2 w-full px-4">
          ...
          <div class="flex flex-wrap justify-center md:justify-start gap-2">
            <UiBadge v-for="(tag, index) in tags" :key="index">{{
              tag
            }}</UiBadge>
          </div>
        </div>
    ...
    <UiSeparator class="container mx-auto bg-accent-foreground" />
    <div>
      <div class="container mx-auto py-4 flex flex-wrap flex-col sm:flex-row">
        <p class="text-gray-500 text-sm text-center sm:text-left">
          © {{ new Date().getFullYear() }} Paperless Hospital —
          <NuxtLink to="#" class="text-accent-foreground font-semibold ml-1"
            >PT. Digital Kreasi Muslim</NuxtLink
          >
        </p>
        <span
          ...
          <NuxtLink
            to="#"
            class="ml-3 cursor-pointer text-primary hover:text-primary/70">
            <svg
              fill="currentColor"
              stroke-linecap="round"
              stroke-linejoin="round"
          ...
          <NuxtLink
            to="https://www.instagram.com/paperlesshospital/"
            target="_blank"
            class="ml-3 cursor-pointer text-primary hover:text-primary/70">
            <svg
              fill="none"
          ...
          <NuxtLink
            to="https://www.linkedin.com/company/muslimlife-pt-digital-kreasi-muslim/"
            target="_blank"
            class="ml-3 cursor-pointer text-primary hover:text-primary/70">
            <svg
              fill="currentColor"
