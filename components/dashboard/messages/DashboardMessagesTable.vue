...
interface DataTableProps {
  columns: ColumnDef<ContactMessages, any>[];
  data: ContactMessages[];
}

const props = defineProps<DataTableProps>();
const emit = defineEmits<{
  openDialog: [contactMessages?: ContactMessages];
  refresh: [];
}>();
...
provide('tableMessageEvents', {
  refresh: () => emit('refresh'),
  openDialog: (contactMessages?: ContactMessages) => emit('openDialog', contactMessages)
});
</script>
